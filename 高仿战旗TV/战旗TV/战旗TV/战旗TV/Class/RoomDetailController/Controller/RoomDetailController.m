...
- (void)playVideo{
    NSString * filePath = [[NSString alloc]initWithString:  [NSString stringWithFormat:@"%@%@.m3u8",HLS_URL,_vid] ];
    NSLog(@"filePath = %@",filePath);
    filePath=[filePath stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding];
//    filePath=[filePath stringByAddingPercentEncodingWithAllowedCharacters:[NSCharacterSet characterSetWithCharactersInString:@"`#%^{}\"[]|\\<> "].invertedSet];
