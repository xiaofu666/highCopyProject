...
#import "zgSCPopView.h"

@interface zgSCNavTabBar () <zgSCPopViewDelegate>
{
    ...
    zgSCPopView       *_popView;              // when item menu, will show this view
    ...
    if (pop)
    {
        ...
        [UIView animateWithDuration:0.5f animations:^{
            ...
            [UIView animateWithDuration:0.2f animations:^{
                if (!_popView)
                {
                    _popView = [[zgSCPopView alloc] initWithFrame:CGRectMake(DOT_COORDINATE, NAVIGATION_BAR_HEIGHT + 20, SCREEN_WIDTH, self.frame.size.height - NAVIGATION_BAR_HEIGHT)];
...
- (void)updateData
{
    _arrowButton.backgroundColor = [UIColor greenColor];
