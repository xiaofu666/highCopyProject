...
@implementation WRCommunityJieBanCell
-(id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier{
    ...
    if (self) {
        ...
        self.detailLabel=[[UILabel alloc]initWithFrame:[delegate createFrimeWithX:10 andY:40 andWidth:345 andHeight:20]];
