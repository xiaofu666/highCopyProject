...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        cartNumLabel = [UILabel new];
        cartNumLabel.text = @"0";
        cartNumLabel.font = [UIFont systemFontOfSize:11];
        cartNumLabel.textColor = kColorWhite;
        cartNumLabel.textAlignment = NSTextAlignmentCenter;
        cartNumLabel.layer.cornerRadius = 6;
        cartNumLabel.layer.backgroundColor = kColorRed.CGColor;
        cartNumLabel.hidden = YES;
                ...
                hasCollectedProduct:(BOOL)hasCollectedProduct
{
    ...
    [self setCartNum:cartNum];
    [self setHasCollectedProduct:hasCollectedProduct];
}

- (void)setCartNum:(NSNumber *)cartNum
{
    cartNumLabel.text = [NSString stringWithFormat:@"%@", cartNum];
    cartNumLabel.hidden = NO;
}
