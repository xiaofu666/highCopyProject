...
- (void)getFeaturedProducts
{
    ...
    [ProductModel getFeaturedProducts:^(BOOL result, NSString *message, NSArray *products) {
        if (result) {
...
{
    [ProductModel getTopicProducts:^(BOOL result, NSString *message, NSArray *products) {
        if (result) {
...
{
    [ProductModel getTopSaleProducts:^(BOOL result, NSString *message, NSArray *products) {
        if (result) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    ProductController *ctrl = [[ProductController alloc] initWithProductId:productId];
