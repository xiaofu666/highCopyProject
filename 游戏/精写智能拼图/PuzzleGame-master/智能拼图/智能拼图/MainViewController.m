...
-(CGRect)FrameForIndex:(int)i
{
    ...
    CGFloat imageWidth = self.bgImage.frame.size.width;
    int rowNum = (int)sqrt(itemSum);
    x=i%rowNum*imageWidth/sqrt(itemSum);
    y=i/rowNum*imageWidth/sqrt(itemSum);
    width=imageWidth/sqrt(itemSum);
    height=imageWidth/sqrt(itemSum);
