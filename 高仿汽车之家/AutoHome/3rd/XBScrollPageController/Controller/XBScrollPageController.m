...
- (void)viewDidLayoutSubviews
{
    ...
    self.tagCollectionView.frame = CGRectMake(0, 0, XBScreenWidth -40 , self.tagViewHeight);
...
- (void)setupDefaultProperties
{
    ...
    self.selectedIndicatorColor = getColorRGBA(216, 79, 79, 1);
