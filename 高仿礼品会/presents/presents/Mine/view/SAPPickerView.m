...
#import "SAPPickerView.h"

@interface SAPPickerView()<UIPickerViewDataSource, UIPickerViewDelegate>
...
-(UIToolbar *)setToolbarStyle{
    ...
    lefttem.tintColor = [UIColor redColor];
